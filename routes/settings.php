...
Route::middleware(['auth', 'verified', 'plan.access'])->group(function () {
    ...
    Route::post('settings/brand', [SystemSettingsController::class, 'updateBrand'])->middleware('permission:manage-system-settings')->name('settings.brand.update');
    Route::post('settings/storage', [SystemSettingsController::class, 'updateStorage'])->middleware('permission:manage-system-settings')->name('settings.storage.update');
    Route::post('settings/recaptcha', [SystemSettingsController::class, 'updateRecaptcha'])->middleware('permission:manage-system-settings')->name('settings.recaptcha.update');
    Route::post('settings/chatgpt', [SystemSettingsController::class, 'updateChatgpt'])->middleware('permission:manage-system-settings')->name('settings.chatgpt.update');
    Route::post('settings/cookie', [SystemSettingsController::class, 'updateCookie'])->middleware('permission:manage-system-settings')->name('settings.cookie.update');
    Route::post('settings/seo', [SystemSettingsController::class, 'updateSeo'])->middleware('permission:manage-system-settings')->name('settings.seo.update');
    Route::post('settings/cache/clear', [SystemSettingsController::class, 'clearCache'])->middleware('permission:manage-system-settings')->name('settings.cache.clear');
