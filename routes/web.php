...
Route::middleware(['auth', 'verified', 'permission:manage-email-templates'])->group(function () {
...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::post('api/media/directories', [MediaController::class, 'createDirectory'])->middleware('permission:create-media-directories')->name('api.media.directories.create');
